...
from .models import  Aluno, Perfil_do_Servidor, Familia, Perfil_do_Aluno, Curso
...
class PerfilAdmin(admin.ModelAdmin):
    ...
    list_display = ['aluno', 'nota_ensino', 'nota_comportamento', 'saude', 'reside', 'objetivos',
                    'foto', 'motivo']
    list_filter = ['nota_ensino', 'nota_comportamento', 'reside', 'motivo', 'objetivos']
    search_fields = ['aluno__nome']
    save_on_top = True
...
class CursoAdmin(admin.ModelAdmin):
    model = Curso
    list_display = ['aluno', 'curso', 'forma']
    list_filter = ['curso', 'forma']
    search_fields = ['aluno__nome']
    save_on_top = True
